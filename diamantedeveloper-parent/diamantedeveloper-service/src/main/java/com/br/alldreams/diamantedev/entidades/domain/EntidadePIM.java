 ...
 */
@Entity
@Table(name = "tb_entidade_pim")
@NamedQueries({ @NamedQuery(name = EntidadePIM.GETLALL, query = "SELECT u FROM EntidadePIM u WHERE u.status <> 'REMOVIDO' ") })
public class EntidadePIM implements Serializable {
	public static final String GETLALL = "EntidadePIM.getAll";

 ...
 */
@Entity
@Table(name = "tb_atributo_pim")
@NamedQueries({ @NamedQuery(name = AtributoPIM.GETLALL, query = "SELECT u FROM AtributoPIM u WHERE u.status <> 'REMOVIDO' ") })
public class AtributoPIM implements Serializable {

	public static final String GETLALL = "AtributoPIM.getAll";

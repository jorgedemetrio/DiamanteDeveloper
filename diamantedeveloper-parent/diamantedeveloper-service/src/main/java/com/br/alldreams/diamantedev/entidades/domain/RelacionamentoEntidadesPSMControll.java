 ...
 */
@Entity
@Table(name = "tb_relacionamento_psm_c")
@NamedQueries({ @NamedQuery(name = RelacionamentoEntidadesPSMControll.GETLALL, query = "SELECT u FROM RelacionamentoEntidadesPSMControll u WHERE u.status <> 'REMOVIDO' ") })
public class RelacionamentoEntidadesPSMControll implements Serializable {

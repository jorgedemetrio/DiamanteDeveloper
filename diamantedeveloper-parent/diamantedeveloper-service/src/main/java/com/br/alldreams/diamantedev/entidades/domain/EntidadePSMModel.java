 ...
 */
@Entity
@Table(name = "tb_entidade_psm_m")
@NamedQueries({ @NamedQuery(name = EntidadePSMModel.GETLALL, query = "SELECT u FROM EntidadePSMModel u WHERE u.status <> 'REMOVIDO' ") })
public class EntidadePSMModel implements Serializable {

 ...
 */
@Entity
@Table(name = "tb_atributo_psm_c")
@NamedQueries({ @NamedQuery(name = AtributoPSMControll.GETLALL, query = "SELECT u FROM AtributoPSMControll u WHERE u.status <> 'REMOVIDO' ") })
public class AtributoPSMControll implements Serializable {

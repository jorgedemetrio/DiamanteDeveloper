 ...
 * @version 1.0
 * @since 13/11/2015 14:24:07
 */
@Entity
@Table(name = "tb_entidade_psm_c")
@NamedQueries({ @NamedQuery(name = EntidadePSMControll.GETLALL, query = "SELECT u FROM EntidadePSMControll u WHERE u.status <> 'REMOVIDO' ") })
public class EntidadePSMControll implements Serializable {
	public static final String GETLALL = "EntidadePSM.getAll";

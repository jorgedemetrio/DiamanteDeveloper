 ...
 */
@Entity
@Table(name = "tb_relacionamento_psm_m")
@NamedQueries({ @NamedQuery(name = RelacionamentoEntidadesPSMModel.GETLALL, query = "SELECT u FROM RelacionamentoEntidadesPSMModel u WHERE u.status <> 'REMOVIDO' ") })
public class RelacionamentoEntidadesPSMModel implements Serializable {

 ...
 */
@Entity
@Table(name = "tb_relacionamento_pim")
@NamedQueries({ @NamedQuery(name = RelacionamentoEntidadesPIM.GETLALL, query = "SELECT u FROM RelacionamentoEntidadesPIM u WHERE u.status <> 'REMOVIDO' ") })
public class RelacionamentoEntidadesPIM implements Serializable {
	public static final String GETLALL = "RelacionamentoEntidadesPIM.getAll";

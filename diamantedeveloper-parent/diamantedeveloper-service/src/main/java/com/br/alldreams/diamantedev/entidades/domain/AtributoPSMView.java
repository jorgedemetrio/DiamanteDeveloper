 ...
 */
@Entity
@Table(name = "tb_atributo_psm_v")
@NamedQueries({ @NamedQuery(name = AtributoPSMView.GETLALL, query = "SELECT u FROM AtributoPSMView u WHERE u.status <> 'REMOVIDO' ") })
public class AtributoPSMView implements Serializable {

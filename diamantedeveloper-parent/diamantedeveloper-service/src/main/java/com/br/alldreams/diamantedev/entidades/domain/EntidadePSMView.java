 ...
 */
@Entity
@Table(name = "tb_entidade_psm_v")
@NamedQueries({ @NamedQuery(name = EntidadePSMView.GETLALL, query = "SELECT u FROM EntidadePSMView u WHERE u.status <> 'REMOVIDO' ") })
public class EntidadePSMView implements Serializable {
